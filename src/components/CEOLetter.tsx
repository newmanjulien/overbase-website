        ...
        <div className="relative mx-auto max-w-3xl">
          ...
          <div className="relative bg-white rounded-lg shadow-xl p-8 md:p-12 transform rotate-0 z-10">
            ...
            <div className="space-y-6 text-gray-900 leading-relaxed">
              ...
              <p>
                Check out this <a href="https://hndl.notion.site/Q-A-246226f80dd38065a1eac0e6321967da" target="_blank" class="black-text">Q&A if you have questions</a>. Or join our waitlist and I&apos;ll be in touch quickly to help you
