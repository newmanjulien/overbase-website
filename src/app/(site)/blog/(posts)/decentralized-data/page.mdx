...
The future will be autonomous systems built around the new paradigms which are enabled by AI
...
- **Real-world example:** Overbase has built an autonomous system which delivers all the value but is still supported by humans and isn't yet fully automated
