export const metadata = {
  ...
  description:
    "For centuries, Western universities were engines of talent. Students were pushed relentlessly, programs demanded deep mastery, and only those who could survive that pressure emerged capable of real impact.",
};
...
### 1. Training and sorting are collapsing
...
### 3. Elite degrees as countersignal
...
## Rise of the new talent strategy
...
Smart companies are embedding themselves in these remaining hubs to capture talent, before others have the time to shift.
...
## Quant firms create modern talent pipelines
...
## The new talent war matters more than ever
